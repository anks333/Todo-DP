...
export abstract class BaseModel {
    ...
    protected static async findOneAndUpdate<B extends Document, U>(
        query: any, update: any, m: Model<B>, classC: any): Promise<U> {
        let entity: any;
        try {
    ...
    protected static async findOneAndUpsert<B extends Document, U>(
        query: any, update: any, m: Model<B>, classC: any): Promise<U> {
        let entity: any;
        try {
